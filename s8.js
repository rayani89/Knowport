...
l1: [
  {
    tipo: "alternativa",
    pergunta: "'Quente' em inglês é:",
    alternativas: ["Cold", "Hot", "Freezing", "Cool"],
    correta: 1
  },
  {
    tipo: "escrever",
    pergunta: "Complete: 'It’s very ___ today, wear a jacket.' → (windy / freezing / rainy)",
    resposta: "freezing"
  },
  {
    tipo: "traduzir-pt",
    pergunta: "'Windy.' significa:",
    resposta: "Ventoso."
  },
  {
    tipo: "traduzir-en",
    pergunta: "Traduza: 'Está nublado.'",
    resposta: "It’s cloudy."
  },
  {
    tipo: "alternativa",
    pergunta: "Qual dessas palavras NÃO é sobre temperatura?",
    alternativas: ["Hot", "Freezing", "Rainy", "Warm"],
    correta: 2
  }
],
...
l2: [
  {
    tipo: "alternativa",
    pergunta: "'Tarde' em inglês é:",
    alternativas: ["Evening", "Afternoon", "Night", "Morning"],
    correta: 1
  },
  {
    tipo: "escrever",
    pergunta: "Complete: 'Leaves fall in ___.' → (Autumn / Summer / Spring)",
    resposta: "Autumn"
  },
  {
    tipo: "traduzir-en",
    pergunta: "'Inverno é frio.' em inglês é:",
    resposta: "Winter is cold"
  },
  {
    tipo: "traduzir-pt",
    pergunta: "'Morning' significa:",
    resposta: "Manhã"
  },
  {
    tipo: "alternativa",
    pergunta: "Qual NÃO é uma estação do ano?",
    alternativas: ["Summer", "Cloudy", "Autumn", "Winter"],
    correta: 1
  }
],
...
l3: [
  {
    tipo: "alternativa",
    pergunta: "Como se diz 'Eu adoro caminhar na chuva!' em inglês?",
    alternativas: [
  ...
  {
    tipo: "escrever",
    pergunta: "Complete: '___ outside, wear a coat!' → (It’s freezing / The sun is shining / I’m tired)",
    resposta: "It’s freezing"
  },
  {
    tipo: "traduzir-pt",
    pergunta: "'O tempo está terrível!' em inglês é:",
    resposta: "The weather is terrible!"
  },
  {
    tipo: "traduzir-pt",
    pergunta: "'The sun is shining.' em português significa:",
    resposta: "O sol está brilhando."
  },
  {
    tipo: "alternativa",
    pergunta: "Qual dessas expressões indica calor extremo?",
    alternativas: [
