...
l1: [
  {
    tipo: "alternativa",
    pergunta: "'I love painting' significa:",
    alternativas: ["Eu adoro pintar", "Eu estou aprendendo a pintar", "Eu sou bom em pintar", "Eu gosto de desenhar"],
    correta: 0
  },
  {
    tipo: "traduzir-pt",
    pergunta: "'I'm good at playing games' em português significa:",
    resposta: "Eu sou bom em jogar jogos"
  },
  {
    tipo: "escrever",
    pergunta: "Complete: 'Gardening It's my favorite _____' → (hobby / sport / skill)",
    resposta: "hobby"
  },
  {
    tipo: "escrever",
    pergunta: "Complete: 'I like to play ____' → (Football / Tennis / Yoga)",
    resposta: "Football"
  },
  {
    tipo: "traduzir-en",
    pergunta: "'Eu gosto de escrever' em inglês é:",
    resposta: "I like to write"
  }
],
...
l2: [
  {
    tipo: "traduzir-pt",
    pergunta: "'I'm learning to sing' significa:",
    resposta: "Eu estou aprendendo a cantar"
  },
  {
    tipo: "escrever",
    pergunta: "Complete: 'She is good at ______ pictures.' → (painting / writing / cooking)",
    resposta: "painting"
  },
  {
    tipo: "traduzir-en",
    pergunta: "'Eu adoro nadar.' em inglês é:",
    resposta: "I love to swim"
  },
  {
    tipo: "traduzir-pt",
    pergunta: "'He is interested in photography' em português é:",
    resposta: "Ele está interessado em fotografia"
  },
  {
    tipo: "escrever",
    pergunta: "Complete: 'I love to _______ music.' → (listen to / write / read)",
    resposta: "listen to"
  }
],
...
l3: [
  {
    tipo: "traduzir-pt",
    pergunta: "'They are passionate about traveling' significa:",
    resposta: "Eles são apaixonados por viajar"
  },
  {
    tipo: "escrever",
    pergunta: "Complete: 'I'm good at ______ sports.' → (playing / painting / reading)",
    resposta: "playing"
  },
  {
    tipo: "traduzir-en",
    pergunta: "'Nós estamos aprendendo a dançar.' em inglês é:",
    resposta: "We are learning to dance"
  },
  {
    tipo: "traduzir-pt",
    pergunta: "'I like to watch movies' em português é:",
    resposta: "Eu gosto de assistir filmes"
  },
  {
    tipo: "escrever",
    pergunta: "Complete: 'Yoga is my favorite ______.' → (sport / hobby / expression)",
    resposta: "hobby"
  }
]
